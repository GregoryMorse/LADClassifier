...
try:
    import numba
except ImportError:  # Optional acceleration; compatibility helpers do not require it.
...
except ImportError:  # Plotting is not required for classification or binarization.
    class _MissingPlot:
        class cm:
            Blues = None

        def __getattr__(self, _name):
            raise RuntimeError("install LADClassifier[plot] to create plots")
